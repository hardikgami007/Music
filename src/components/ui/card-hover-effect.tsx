...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-neutral-200 border border-transparent relative z-20",
        className
      )}
    >
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "mt-8 text-neutral-600 tracking-wide leading-relaxed text-sm",
        className
      )}
    >
      {children}
